...
ttk.Label(frame1, text='Hard Totals').grid(column=0, row=0)
...
ttk.Label(frame1, text='Pairs').grid(column=0, row=8)
...
ttk.Label(frame2, text='Dealer Card').grid(column=0, row=0)
